...
function getTitle($url) {
  ...
  function userinput($message){
    global $white, $bold, $redbg, $redbg, $bluebg, $cln, $lblue, $black;
    $yellowbg = "\e[100m";
    $inputstyle = $cln . $bold . $black . "[~] " . $message . ": " . $red ;
  echo $inputstyle;
  }
...
function extract_social_links($sourcecode){
  /* This is really a simple code for now i will work around it on the upcoming version.
     For now only these social media are supported:
      ...
      - GitHUB
  */
  global $bold, $lblue, $fgreen, $red, $blue, $magenta, $orange, $white, $red, $grey, $cyan;
  $fb_link_count = 0;
